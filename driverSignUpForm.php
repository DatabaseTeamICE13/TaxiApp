...
<div class="container-fluid" style="align-items: center">
    ...
    <div class="col-md-9" style="padding-left: 450px">
        <form class="form-group" id="sign_up_form" action="driverSignUp.php" method="POST">
            ...
            <input type="text" id="nic" class="form-control" placeholder="NIC No" required autofocus>
            ...
            <input type="text" id="vehicleNo" class="form-control" placeholder="Vehicle No" required autofocus>
            <label for="vehicleType" class="control-label" style="padding-top: 20px">Enter Your Vehicle Type</label>
            <input type="text" id="vehicleType" class="form-control" placeholder="Vehicle Type" required autofocus>
            <br>
